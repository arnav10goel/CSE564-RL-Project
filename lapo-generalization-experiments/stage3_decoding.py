...
policy_path = "exp_results/generalization3_16/latent_policy.pt"
models_path = "exp_results/generalization3_16/idm_fdm.pt"
...
if policy_path:
    ...
    _path = paths.get_latent_policy_path(config.get().exp_name)
    print(f"No policy argument provided, loading policy from {_path}")
